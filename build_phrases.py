...
# Define the base TS imports and language definitions
...
export interface UniversalPhrase {
  ...
  // Localized category title per native language
  categoryTitles: Record<string, string>;
  // Phrase text per language
  phrases: Record<string, string>;
  // Phonetic pronunciation per language
  phonetics?: Record<string, string>;
  // Explanation in each native language
  explanations: Record<string, string>;
  // Wrong options in target language
...
export const uiTranslations: Record<string, Record<string, string>> = {
  turkish: {
    ...
    appSub: "Anadilinizi seçin ve dilediğiniz dili 200 kapsamlı soru ile öğrenin!",
    ...
    matrixSub: "İfadenin dünyadaki tüm desteklenen 11 dildeki karşılığını aynı anda görün ve seslendirmesini dinleyin.",
  ...
  english: {
    ...
    appSub: "Select your native language and master any target language with 200 comprehensive questions!",
  ...
  spanish: {
    ...
    appSub: "¡Elige tu idioma materno y domina cualquier idioma con 200 preguntas exhaustivas!",
  ...
  arabic: {
    ...
    appSub: "اختر لغتك الأم وأتقن أي لغة أجنبية من خلال 200 سؤال شمولية!",
...
print('Header python compiled successfully')
